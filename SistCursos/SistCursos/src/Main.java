...
public class Main {
    ...
    do{
        op = Integer.parseInt(JOptionPane.showInputDialog("Digite o numero da operação:"
                ...
                +"\n4 - Listar estudanes matriculados"
        ));
        switch (op)
        {
            //cadastro aluno
            ...
            case 4:
            JOptionPane.showMessageDialog(null, "===Listando Alunos matriculados==="+
                    "\n--Aluno:Elisangelo Matricula:22113456 Cursando: Git e GitHub" +
                    "\n--Aluno:Laudicéia Matricula:98768987 Cursando:Git e GitHub"+
                    "\n--Aluno:NIckolas  Matricula:43252344 Cursando:Programação Procedural");
